        ...
        <div className="cola1">
          ...
          >
            <div className="cards">
              <div className="card">
                <p>
                  Completed <br /> 7+ projects
                </p>
              </div>
              <div className="card">
                <p>
                  Proficient in <br /> Development
                </p>
              </div>
            </div>
            <br />
            <p className="sum">
              ...
              Technology in Computer Science with specialization in DATA
              SCIENCE. I am very passionate about Web Development & Data Science
              have a keen interest to learn more new technologies.
            </p>
            <br />
